...
/* viewforum_body.html */
class __TwigTemplate_0752e1b25b53d1dc75ecffa3d7117d200b7ec85ed782671187cf1196bc699fe1 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t";
            ...
            if ((( !($context["S_IS_BOT"] ?? null) && ($context["U_MARK_TOPICS"] ?? null)) && twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["loops"] ?? null), "topicrow", [], "any", false, false, false, 71)))) {
                ...
                echo "\" class=\"mark responsive-show-inline\" style=\"display:none;\" accesskey=\"m\" data-ajax=\"mark_topics_read\">";
...
\t\t\t";
            // line 289
            if ((( !($context["S_IS_BOT"] ?? null) && ($context["U_MARK_TOPICS"] ?? null)) && twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["loops"] ?? null), "topicrow", [], "any", false, false, false, 289)))) {
                echo "<a href=\"";
                echo ($context["U_MARK_TOPICS"] ?? null);
...
\t\t\t";
            // line 291
            if (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["loops"] ?? null), "pagination", [], "any", false, false, false, 291))) {
                // line 292
                echo "\t\t\t\t";
                $location = "pagination.html";
                $namespace = false;
...
\t\t<p>";
            // line 312
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, ($context["loops"] ?? null), "rules", [], "any", false, false, false, 312));
            foreach ($context['_seq'] as $context["_key"] => $context["rules"]) {
                echo twig_get_attribute($this->env, $this->source, $context["rules"], "RULE", [], "any", false, false, false, 312);
                echo "<br />";
            }
            $_parent = $context['_parent'];
