...
class phpbb_cache_container extends \Symfony\Component\DependencyInjection\Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = [
            ...
            'threedi.dae.dae' => 'getThreedi_Dae_DaeService',
            'threedi.dae.listener' => 'getThreedi_Dae_ListenerService',
        ...
        $this->privates = [
            ...
            'threedi.dae.dae' => true,
            'threedi.dae.listener' => true,
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addListener('core.user_setup', [0 => function () {
            return ${($_ = isset($this->services['threedi.dae.listener']) ? $this->services['threedi.dae.listener'] : $this->getThreedi_Dae_ListenerService()) && false ?: '_'};
        }, 1 => 'dae_load_language_on_setup'], 0);
        $instance->addListener('core.permissions', [0 => function () {
            return ${($_ = isset($this->services['threedi.dae.listener']) ? $this->services['threedi.dae.listener'] : $this->getThreedi_Dae_ListenerService()) && false ?: '_'};
        }, 1 => 'dae_permissions'], 0);
        $instance->addListener('core.get_avatar_after', [0 => function () {
            return ${($_ = isset($this->services['threedi.dae.listener']) ? $this->services['threedi.dae.listener'] : $this->getThreedi_Dae_ListenerService()) && false ?: '_'};
        }, 1 => 'dae_default_avatar'], 0);
    ...
    /**
     * Gets the private 'threedi.dae.dae' shared service.
     *
     * @return \threedi\dae\core\dae
     */
    protected function getThreedi_Dae_DaeService()
    {
        return $this->services['threedi.dae.dae'] = new \threedi\dae\core\dae(${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, './../');
    }

    /**
     * Gets the private 'threedi.dae.listener' shared service.
     *
     * @return \threedi\dae\event\listener
     */
    protected function getThreedi_Dae_ListenerService()
    {
        return $this->services['threedi.dae.listener'] = new \threedi\dae\event\listener(${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['threedi.dae.dae']) ? $this->services['threedi.dae.dae'] : $this->getThreedi_Dae_DaeService()) && false ?: '_'});
    }
